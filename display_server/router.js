...
var CT = require('./server_modules/country-list');
var AM = require('./server_modules/account-manager');
var EM = require('./server_modules/email-dispatcher');
...
// main login page //
	...
	// check if the user's credentials are saved in a cookie //
		if (req.cookies.user == undefined || req.cookies.pass == undefined){
			res.render('login', { title: 'Project Grandmaster - Login to add your own data and compare' });
		}	else{
